 ...
 * Use the [ActivationCodeEntryFragment.newInstance] factory method to
...
class ActivationCodeEntryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ActivationCodeEntryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ActivationCodeEntryFragment().apply {
